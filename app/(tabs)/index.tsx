    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={{ justifyContent: "center", width: "100%", height: 120 }}>
          <Text style={{
            top: 0, position: "absolute", color: "#000", fontSize: 50,
              ...
              >
                ...
                <View style={styles.balanceContainer}>
                  ...
                  <Text style={styles.balanceAmount}>
                    {Math.floor(card.balance).toLocaleString()}
                  </Text>
                  <Text style={styles.balanceCents}>
                    .{(card.balance % 1).toFixed(2).split('.')[1]}
                  </Text>
                </View>
                ...
                <View style={styles.cardFooter}>
                  <Text style={styles.cardNumber}>
                    {index === 0 ? '6358' : '2221'} .... .... {card.lastFour}
                  </Text>
                  {card.hasContactless && (
